...
<nav class="flex items-center justify-between flex-wrap bg-white py-4 px-24 border-red border-b-4">
    ...
    <div class="hidden md:block w-full flex-grow lg:flex lg:items-center lg:w-auto">
        ...
        <div class="hidden md:block">
            ...
            <a href="/contact-us" class="bg-red inline-block px-4 py-4 leading-none border-2 rounded text-white border-red hover:text-red hover:bg-white mt-4 lg:mt-0" title="Contact {{ $page->siteName }}">Request A Free Quote</a>
        </div>
    </div>
</nav>
