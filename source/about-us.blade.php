    ...
    <section class="container mx-auto p-6 mt-2">
        <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
            ...
            <p>
                ...
                Trees aren't always planted in the right location and can potentially do a lot of damage. Before removal is an option we
                can help save your tree. Structural pruning methods and root pruning are just 2 ways to make your tree safe and worry
                free. For our commercial customers we have the tools to keep your trees healthy and safe. Proper pruning methods
