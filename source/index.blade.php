...
@section('body')
    ...
    <section class="container mx-auto pt-10 mt-16 pb-20">
        <div class="md:flex -mx-2 -mx-4">
            <div class="md:w-2/3 text-center mx-auto pb-10">
                <h3 class="text-red">First-Rate Service</h3>
        ...
        <div class="md:flex -mx-2 -mx-4">
            <div class="mb-8 mx-3 px-2 md:w-1/4 bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 ml-auto">
            ...
            <div class="mb-8 mx-3 px-2 md:w-1/4 bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 mr-auto">
    ...
    <section>
        <div class="bg-red-darkest py-10">
                <div class="md:flex -mx-2 -mx-4">
                    <div class="w-1/2 content-center mx-auto" style="text-align:center">
